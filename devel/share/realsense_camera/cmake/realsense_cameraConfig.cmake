...
if("TRUE" STREQUAL "TRUE")
  set(realsense_camera_SOURCE_PREFIX /home/maowei/catkin_ws/src/ras_realsense/realsense_camera)
  set(realsense_camera_DEVEL_PREFIX /home/maowei/catkin_ws/devel)
  ...
  set(realsense_camera_INSTALL_PREFIX /home/maowei/catkin_ws/install)
...
if(NOT "/home/maowei/catkin_ws/devel/include;/home/maowei/catkin_ws/src/ras_realsense/realsense_camera/include " STREQUAL " ")
  set(realsense_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/maowei/catkin_ws/devel/include;/home/maowei/catkin_ws/src/ras_realsense/realsense_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Rajvi Jingar <rajvi.jingar@intel.com>, Reagan Lopez <reagan.lopez@intel.com>, Mark Horn <mark.d.horn@intel.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'realsense_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/maowei/catkin_ws/src/ras_realsense/realsense_camera/${idir}'.  Ask the maintainer 'Rajvi Jingar <rajvi.jingar@intel.com>, Reagan Lopez <reagan.lopez@intel.com>, Mark Horn <mark.d.horn@intel.com>' to fix it.")
    endif()
...
set(depends "librealsense;std_msgs;message_runtime;sensor_msgs")
