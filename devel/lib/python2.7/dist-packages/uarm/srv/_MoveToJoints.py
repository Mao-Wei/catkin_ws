...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4f4iB.pack(_x.j0, _x.j1, _x.j2, _x.j3, _x.move_mode, _x.movement_duration.secs, _x.movement_duration.nsecs, _x.interpolation_type, _x.check_limits))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.j0, _x.j1, _x.j2, _x.j3, _x.move_mode, _x.movement_duration.secs, _x.movement_duration.nsecs, _x.interpolation_type, _x.check_limits,) = _struct_4f4iB.unpack(str[start:end])
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4f2iB.pack(_x.j0, _x.j1, _x.j2, _x.j3, _x.elapsed.secs, _x.elapsed.nsecs, _x.error))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.j0, _x.j1, _x.j2, _x.j3, _x.elapsed.secs, _x.elapsed.nsecs, _x.error,) = _struct_4f2iB.unpack(str[start:end])
